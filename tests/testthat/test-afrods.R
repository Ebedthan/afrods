...
test_that("data objects are unchanged", {
  ...
  expect_equal_to_reference(energy, "energy.rds")
  expect_equal_to_reference(health, "health.rds")
  expect_equal_to_reference(infrastructure, "infrastructure.rds")
  expect_equal_to_reference(population, "population.rds")
  expect_equal_to_reference(society, "society.rds")
  expect_equal_to_reference(technology, "technology.rds")
  expect_equal_to_reference(work, "work.rds")
